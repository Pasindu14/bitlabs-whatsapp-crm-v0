...
description: Apply this rule to anything in the Actions layer (features/**/actions/*-actions.ts): Next.js server actions wrapped with withAction, validation, service delegation, auth context, and Result<T> unwrapping.
---
